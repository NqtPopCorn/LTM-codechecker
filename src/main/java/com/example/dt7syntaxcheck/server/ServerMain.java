...
public class ServerMain {
    ...
    public static void main(String[] args) {
        ...
        ErrorLog[] errors = checker.syntaxCheck("C:/Users/truon/OneDrive/Documents/LTM/temp/a.py");
        if (errors.length == 0) {
            System.out.println("No syntax errors found.");
            PythonExecutor executor = new PythonExecutor();
            String output = executor.execute("C:/Users/truon/OneDrive/Documents/LTM/temp/a.py");
